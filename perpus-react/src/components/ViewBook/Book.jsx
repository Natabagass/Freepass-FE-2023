...
const Book = (book) => {
    ...
    return (
        <div className="flex px-12 py-12 m-3 bg-white shadow-lg rounded-xl hover:-translate-y-3 transition hover:shadow-lg hover:shadow-gray-500 book-item flex-col">
            ...
            <div className='book-item-info text-center text-gray-700 my-[20px]'>
                <Link to={`/book/${book.id}`} target="_blank" {...book}>
                    <div className='book-item-info-item font-bold mt-3 text-[18px]'>
