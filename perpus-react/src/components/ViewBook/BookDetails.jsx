            ...
            <div className="m-[50px]">
                ...
                <div className="flex flex-row justify-between py-[50px]">
                    <div className="flex justify-end">
                        <button type="submit" className="bg-blue-500 text-white lg:px-2 px-1 py-1 lg:py-1 rounded-lg hover:bg-blue-600 focus:outline-none mr-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="lg:w-6 w-5 h-5 lg:h-6">
                                <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32l8.4-8.4z" />
                                <path d="M5.25 5.25a3 3 0 00-3 3v10.5a3 3 0 003 3h10.5a3 3 0 003-3V13.5a.75.75 0 00-1.5 0v5.25a1.5 1.5 0 01-1.5 1.5H5.25a1.5 1.5 0 01-1.5-1.5V8.25a1.5 1.5 0 011.5-1.5h5.25a.75.75 0 000-1.5H5.25z" />
                            </svg>
                        </button>
                        <button type="submit" className="bg-red-500 text-white lg:px-2 px-3 py-1 lg:py-1 rounded-lg hover:bg-red-600 focus:outline-none"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="lg:w-6 w-5 h-5 lg:h-6">
                    ...
                    <div className="flex justify-start">
                        <a href="/book" className="p-2 px-5 text-white rounded-lg bg-green-500 hover:bg-green-600">Back</a>
                    </div>
                </div>
            </div>
        </div>
