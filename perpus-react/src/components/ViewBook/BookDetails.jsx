            ...
            <div className="m-[50px]">
                ...
                <div className="flex flex-row justify-between py-[50px]">
                    <div className="flex justify-end">
                        ...
                        <button type="submit" className="bg-red-500 text-white px-3 py-1 rounded-lg hover:bg-red-600 focus:outline-none"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
